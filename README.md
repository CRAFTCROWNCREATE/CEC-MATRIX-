...
<head>
    ...
    <style>
        ...
        body { background: var(--bg); color: var(--neon); font-family: 'Courier New', monospace; margin: 0; height: 100vh; overflow: hidden; display: flex; flex-direction: column; -webkit-user-select: none; }
        
        /* VISUAL LAYERS */
        #matrix-layer { position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: -1; opacity: 0.4; }
...
<body>
    ...
    <div id="lock">
        ...
        <button class="btn" style="width: auto; margin-top: 30px; background: transparent; border-color: #555; color: #555;" onclick="toggleQR()">SHOW LINK QR</button>
    </div>
    ...
    <div id="qr-modal" onclick="this.style.display='none'">
        <div id="qrcode"></div>
        <div style="color:#fff; margin-top:20px;">SCAN TO LINK DEVICE</div>
    </div>
    ...
    <script>
        ...
        // --- 6. QR ---
        function toggleQR(){
            const c=document.getElementById('qr-modal');
